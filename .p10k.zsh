...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    anaconda pyenv goenv nodenv nvm nodeenv node_version go_version
    rust_version package rbenv rvm fvm luaenv jenv plenv phpenv scalaenv
    haskell_stack kubecontext terraform aws aws_eb_env azure gcloud
    google_app_cred context nordvpn ranger nnn vim_shell midnight_commander
    nix_shell todo timewarrior taskwarrior time
  )
  ...
  local anchor_files=(
    ...
    .lua-version .java-version .perl-version .php-version .tool-version .shorten_folder_marker
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%209F'  # yellow foreground
      local  staged='%186F'  # green foreground
      local  untracked='%111F'   # blue foreground
      local conflicted='%203F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%17F'  # grey foreground
      local      clean='%17F'  # grey foreground
      local   modified='%17F'  # grey foreground
      local  untracked='%17F'  # grey foreground
      local conflicted='%17F'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=145
  ...
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND=11
  ...
  # Nodeenv color.
  typeset -g POWERLEVEL9K_NODEENV_FOREGROUND=209
  ...
  # Node version color.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=203
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=152
